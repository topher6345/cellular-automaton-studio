    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                shuffledArray = getShuffledArr(array);
                i = 0;
                _a.label = 1;
            case 1:
                if (!(i < shuffledArray.length)) return [3 /*break*/, 4];
                return [4 /*yield*/, shuffledArray[i]];
            case 2:
                _a.sent();
                _a.label = 3;
            case 3:
...
var CellularAutomatonEngine = /** @class */ (function () {
    function CellularAutomatonEngine(size, canvas, controlValues) {
        ...
        this.randomGenerator = mkRandomGenerator(["C3A7A2", "5E7469", "181F1E", "C49F5B", "9E7C7B", "AA9190", "303D38", "796F4D", "95957E", "3E5A4C"]);
    }
...
sel("#amp").addEventListener("input", function (e) { return (simulation.amp = parseFloat(e.target.value)); });
